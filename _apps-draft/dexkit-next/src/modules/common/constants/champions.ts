...
export const CHAMPIONS: { [key: number]: string } = {
  ...
  [ChainId.Polygon]: '0xf2a669a2749073e55c56e27c2f4edadb7bd8d95d',
  [ChainId.BSC]: '',
...
export const EVENT_HOLDING_AMOUNT: { [key: number]: BigNumber } = {
  [ChainId.Polygon]: ethers.utils.parseUnits('115', 'ether'),
  [ChainId.Mumbai]: ethers.utils.parseUnits('100', 'wei'),
  [ChainId.BSC]: ethers.utils.parseUnits('0.01', 'ether'),
};

export const COIN_LEAGUES_FACTORY_ADDRESS = {
  [ChainId.Mumbai]: '0xA67B9dBfb1371DEBB7f60B681A74798f014cb007',
  [ChainId.Polygon]: '0xc93f920483Db1122D6Fc7f2f832C3610c73C0C8E',
  [ChainId.BSC]: '0xa1B3a09D5f83a52085fd37becb229038bCeacFf3',
};
...
export const COIN_LEAGUES_NFT_FACTORY_ADDRESS = {
  ...
  [ChainId.Polygon]: '0xeb1eb51AB02C824f0c6F43cEcb91C474E6a0Ef32',
  [ChainId.BSC]: '',
};
