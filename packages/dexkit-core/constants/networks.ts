...
export const NETWORK_NAME_SERVER = (
  chainId?: ChainId,
  NETWORKS?: { [key: number]: Network }
) =>
  chainId && NETWORKS && NETWORKS[chainId] ? NETWORKS[chainId].name : undefined;

export const NETWORK_EXPLORER_SERVER = (
  chainId?: ChainId,
  NETWORKS?: { [key: number]: Network }
) =>
  chainId && NETWORKS && NETWORKS[chainId]
    ? NETWORKS[chainId].explorerUrl
    : undefined;

export const NETWORK_SLUG_SERVER = (
  chainId?: ChainId,
  NETWORKS?: { [key: number]: Network }
) =>
  chainId && NETWORKS && NETWORKS[chainId] ? NETWORKS[chainId].slug : undefined;

export const NETWORK_IMAGE_SERVER = (
  chainId?: ChainId,
  NETWORKS?: { [key: number]: Network }
) =>
  chainId && NETWORKS && NETWORKS[chainId]
...
export const NETWORK_SYMBOL_SERVER = (
  chainId?: ChainId,
  NETWORKS?: { [key: number]: Network }
) =>
  chainId && NETWORKS && NETWORKS[chainId]
...
export const NETWORK_COIN_SYMBOL_SERVER = (
  chainId?: ChainId,
  NETWORKS?: { [key: number]: Network }
) =>
  chainId && NETWORKS && NETWORKS[chainId]
...
export const NETWORK_COIN_NAME_SERVER = (
  chainId?: ChainId,
  NETWORKS?: { [key: number]: Network }
) =>
  chainId && NETWORKS && NETWORKS[chainId]
...
export const NETWORK_COIN_IMAGE_SERVER = (
  chainId?: ChainId,
  NETWORKS?: { [key: number]: Network }
) =>
  chainId && NETWORKS && NETWORKS[chainId]
...
export const NETWORK_PROVIDER_SERVER = (
  chainId?: ChainId,
  NETWORKS?: { [key: number]: Network }
) => {
...
export const NETWORK_FROM_SLUG_SERVER = (
  slug?: string,
  NETWORKS?: { [key: number]: Network }
) => {
  if (slug && NETWORKS) {
