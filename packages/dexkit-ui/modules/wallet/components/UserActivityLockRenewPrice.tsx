...
export interface UserActivityLockRenewPriceProps {
  event: UserEvent;
}

export default function UserActivityLockRenewPrice({
  event,
}: UserActivityLockRenewPriceProps) {
  ...
  return (
    <FormattedMessage
      id="renew.key.addr"
      defaultMessage="Renew Key {lockName} for {price} {symbol} "
      values={{
        lockName: (
          <strong>
            <Link
