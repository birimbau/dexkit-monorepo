...
export default function SwitchNetworkDialog({ dialogProps, chainId }: Props) {
        ...
        <Stack spacing={2}>
          <Typography variant="body1">
            <FormattedMessage
              ...
              defaultMessage="Please, switch to {chainName} network on your wallet to continue"
              description="Switch network dialog content text"
              values={{ chainName: <b>{NETWORK_NAME(chainId)}</b> }}
            />
          </Typography>
