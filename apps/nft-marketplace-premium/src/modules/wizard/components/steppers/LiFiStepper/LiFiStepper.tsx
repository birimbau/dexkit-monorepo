...
import LiFiWizardContainer from '../../containers/LiFiWizardContainer';
...
const steps = [
  {
    ...
    description: (
      <FormattedMessage
        ...
        defaultMessage={'Set general info for your LiFi swap app.'}
      />
    ),
  },
  {
    ...
    description: (
      <FormattedMessage
        ...
        defaultMessage={'Choose LiFi swap app theme and font.'}
      />
    ),
  },
  {
    label: 'Choose Tokens',
    id: 'default-tokens',
    description: `Choose default tokens on your LiFi swap app.`,
  },
  {
    label: 'Swap configuration',
    id: 'swap-configuration',
    description: `LiFi swap configuration.`,
  },
];
...
export default function LiFiStepper({ config, onSave, onChange }: Props) {
