...
const WelcomeLifiMessage = dynamic(() =>
  import('../Welcome/WelcomeLifiStepperMessage').then(
    (module) => module.WelcomeLifiMessage,
  ),
);
...
export default function LifiStepperContainer({ site }: Props) {
